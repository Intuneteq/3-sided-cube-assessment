...
export default function Footer() {
  return (
    <footer className="min-h-[16.1875rem] bg-primary-black w-full pt-6 pb-[8.37rem] md:pb-[2.12rem] px-[2.38rem] md:px-[8.56rem] flex flex-col justify-center md:justify-start items-start gap-8 md:gap-6">
      <div className="flex justify-center md:justify-start items-center pb-6 border border-b-primary-white w-full">
        <Link href={"/"}>
          <Image width={196} height={32} alt="logo" src={"/logo.svg"} />
        </Link>
      </div>

      <div
        id="contact"
        className="w-full flex flex-col md:flex-row justify-between gap-[2.19rem] md:gap-0 items-start md:items-center"
      >
        <div
          id="address"
          className="flex flex-col md:flex-row justify-start items-center gap-3 md:gap-10"
        >
          <Address
            city="Bournemouth"
        ...
        <div className="text-primary-white" id="socials">
          <p
            className={`mb-3 ${poppins.className} text-xs font-bold uppercase`}
          >
            GET SOCIAL
          </p>
      ...
      <div
        className={`${anonymous_Pro.className} flex justify-center md:justify-between items-center flex-col md:flex-row text-primary-white w-full text-xs font-bold`}
      >
